								...
								<div class="content">
									...
									<div id="NoticeCenter">
										<table border="1">
											<tr>
												<td>작성자</td>
												<td>${noticeView.notice_writer}</td>
												<td>작성일</td>
												<td>${noticeView.notice_date}</td>
											</tr>
											<tr>
												<td>제목</td>
												<td colspan="3">${noticeView.notice_title}</td>	
											</tr>
											<tr>
												<td colspan="4">${noticeView.notice_contents}</td>
											</tr>
										</table>
												<a href="/erp/notice/noticeList?curPage=${curPage}"><input type="button" value="목록"></a>
											<c:if test="${noticeView.notice_code eq member.code}">
												<a href="/erp/notice/noticeMod?notice_num=${noticeView.notice_num }&&curPage=${curPage}"><input type="button" value="수정"></a>		
												<a href="/erp/notice/noticeDelete?notice_num=${noticeView.notice_num }&&curPage=${curPage}"><input type="button" value="삭제"></a>			
