							...
							<div class="card">
								...
								<div class="content">
									...
									<form action="noticeWrite" method="post">
										<input type="hidden" name="notice_code" value="${member.code}">
										<input type="hidden" value="${member.department}/${member.position}/${member.name}" name="notice_writer">
										<table border="1">
											<tr>
												<td>작성자</td>
												<td>${member.department}/${member.position}/${member.name}</td>
											</tr>
											<tr>
												<td>제목</td>
											...
											<tr>
												<td colspan="2"><textarea rows="" cols="" name="notice_contents"></textarea> </td>
											</tr>
											
										</table>
										<input type="submit" value="저장">
									</form>
										<a href="noticeList"><input type="button" value="뒤로가기"></a>
