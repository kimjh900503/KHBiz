							...
							<div class="card">
								...
								<div class="content">
									...
									<table border="1">
											...
											<tr>
												<td>제목</td>
												<td colspan="3"><input type="text" value="${noticeView.notice_title}" name="notice_title"> </td>	
											</tr>
											<tr>
												<td colspan="4"> <textarea rows="" cols="" name="notice_contents">${noticeView.notice_contents}</textarea></td>
											</tr>
										</table>
									<input type="submit" value="저장">
									</form>
									<a href="noticeView?notice_num=${noticeView.notice_num}&&curPage=${curPage}"><input type="button" value="뒤로가기"></a>
									</div>
