								...
								<div class="content">
									<div id="MemberListView">
											<table class="table" style = "margin-bottom: 0%; text-align:  center;">
												<tr>
													...
													<td  style = "font-weight: bolder; background-color: #f2f2f2; width :20%;">기안자</td>
													<td  style = "font-weight: bolder; background-color: #f2f2f2; width :20%;">작성 날짜</td>
													<td  style = "font-weight: bolder; background-color: #f2f2f2; width : 20%;">결재 만료일</td>
												</tr>
										</table>
										<table class="table table-hover" id="tblExport" style ="text-align: center;">

											<c:forEach items="${getFinSearch}" var="gfs">
											<tr id="${gfs.d_num}" class="fin_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123">
												<input type="hidden" value="${gfs.d_num}" id="d_num">
												<td style="width : 20%;">${gfs.sheet_kind}</td>
												<td style="width : 20%;">${gfs.title }</td>
												<td style="width : 20%;">${gfs.name}</td>
												<td  style="width : 20%;"><fmt:formatDate value="${gfs.up_date}" pattern="yyyy-MM-dd" /></td>
												<td  style="width : 20%;">${gfs.due_per_date }</td>
											</tr>
											</c:forEach>
										<tr>
									...
									<div class="content">
										<div class="row">
											<div class="container-fluid">
												<div class="col-md-12">
													<form action="getWaitSearch" method="post">
															<div
															...
															<input type="search" class="search-query span3"
																placeholder="이름" name="search" style ="height :35px; margin-top: 2%;">
