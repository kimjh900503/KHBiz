								...
								<div class="content" style="text-align: center;">
									...
									<table class="table" style = "margin-bottom: 0%; text-align:  center;">
										...
										<table class="table table-hover" style="text-align: center;">
											...
											<c:forEach items="${reportWaitSearch}" var="rws">
												<tr id="${rws.d_num}" class="wait_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123"> 
													<td style="width : 20%;">${rws.sheet_kind}</td>
													<td style="width : 20%;">${rws.title }</td>
													<td style="width : 20%;"><fmt:formatDate value="${rws.up_date}" pattern="yyyy-MM-dd" /></td>
													<td style="width : 20%;">${rws.due_date}</td>
												</tr>
											</c:forEach>
											<tr>
