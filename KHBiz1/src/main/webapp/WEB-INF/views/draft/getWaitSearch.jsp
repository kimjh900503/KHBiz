								...
								<div class="content">
									<div id="MemberListView">
										...
										<table class="table table-hover"  style="text-align:  center;">
											<c:forEach items="${getWaitSearch}" var="gws">
												<tr  id="${gws.d_num}" class="wait_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123"> 
												<input type="hidden" value="${gws.d_num}" id="d_num">
														<td style="width : 20%;">${gws.sheet_kind}</td>
													<td style="width : 20%;">${gws.title }</td> 
													<td style="width : 20%;">${gws.name}</td>
													<td style="width : 20%;"><fmt:formatDate value="${gws.up_date}" pattern="yyyy-MM-dd" /></td>
													<td style="width : 20%;">${gws.due_date}</td>
												</tr>
											</c:forEach>
												<tr>
