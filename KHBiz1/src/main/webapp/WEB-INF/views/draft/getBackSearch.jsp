									...
									<div id="MemberListView">
										<table class="table" style = "margin-bottom: 0%; text-align:  center;">
												<tr>
													...
													<td  style = "font-weight: bolder; background-color: #f2f2f2; width : 20%;">반려 일자</td>
												</tr>
										</table>
									
										<table class="table table-hover"  style="text-align:  center;">

											<c:forEach items="${getBackSearch}" var="gbs">
											<tr id="${gbs.d_num}" class="back_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123">
												<input type="hidden" value="${gbs.d_num}" id="d_num">
												<td style="width : 20%;">${gbs.sheet_kind}</td>
												<td style="width : 20%;">${gbs.title }</td>
												<td style="width : 20%;">${gbs.name}</td>
												<td style="width : 20%;"><fmt:formatDate value="${gbs.up_date}" pattern="yyyy-MM-dd" /></td>
												<td style="width : 20%;">${gbs.approve_date }</td>
											</tr>
											</c:forEach>
													<tr>
