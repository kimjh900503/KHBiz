						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="content" >
									<div id="MemberListView">
										...
										<table class="table table-hover" style="text-align: center;">
											...
											<c:forEach items="${reportWaitList}" var="rwl">
												<tr id="${rwl.d_num}" class="wait_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123">
													<input type="hidden" class="kind2" value="${rwl.kind2}">
													<td  style="width : 20%;">${rwl.sheet_kind}</td>
													<td  style="width : 20%;">${rwl.title }</td>
													<td  style="width : 20%;"><fmt:formatDate value="${rwl.up_date}" pattern="yyyy-MM-dd" /></td>
													<td  style="width : 20%;">${rwl.due_date}</td>
												</tr>
											</c:forEach>
											<tr>
								...
								<div class="row">
											...
											<form action="reportWaitSearch" method="post">
														<div
