								...
								<div class="content" style="text-align: center;">
									<div id="MemberListView">
										...
										<table class="table table-hover" style="text-align: center;">
											...
											<c:forEach items="${reportBackList}" var="rbl">
												<tr id="${rbl.d_num}" class="back_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123">
													<input type="hidden" class="kind2" value="${rbl.kind2}">
													<td style="width : 20%; ">${rbl.sheet_kind}</td>
													<td style="width : 20%; ">${rbl.title }</td>
													<td style="width : 20%; "><fmt:formatDate value="${rbl.up_date}" pattern="yyyy-MM-dd" /></td>
													<td style="width : 20%; ">${rbl.approve_date}</td>
												</tr>
											</c:forEach>
											<tr>
