									...
									<div id="MemberListView">
										<table class="table" style = "margin-bottom: 0%; text-align:  center;">
												<tr>
													...
													<td  style = "font-weight: bolder; background-color: #f2f2f2; width : 20%;">결재 완료일</td>
												</tr>
												</table>
										...
										<table class="table table-hover" id="tblExport"  style="text-align:  center;">
											...
											<c:forEach items="${getFinList}" var="fl">
												<tr id="${fl.d_num}" class="fin_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123">
												<input type="hidden" value="${fl.d_num}" id="d_num">
													<td  style="width : 20%;">${fl.sheet_kind}</td>
													<td  style="width : 20%;">${fl.title}</td>
													<td  style="width : 20%;">${fl.name}</td>			
													<td  style="width : 20%;"><fmt:formatDate value="${fl.up_date}" pattern="yyyy-MM-dd" /></td>
													<td  style="width : 20%;">${fl.approve_date }</td>
												</tr>
											</c:forEach>
									...
									<div class="content">
										<div class="row">
												<div class="container-fluid" col-md-offset-10>
													<form action="getFinSearch" method="post">
														<div
