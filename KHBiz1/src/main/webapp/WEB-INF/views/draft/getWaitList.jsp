								...
								<div class="content">
									...
									<table class="table" style = "margin-bottom: 0%; text-align:  center;">
										...
										<table class="table table-hover" style="text-align:  center;">
											...
											<tr id="${wl.d_num}" class="wait_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123">
												<input type="hidden" value="${wl.d_num}" id="d_num">
												<td style="width : 20%;">${wl.sheet_kind}</td>
												<td style="width : 20%;">${wl.title }</td>
												<td style="width : 20%;">${wl.name}</td>
												<td style="width : 20%;"><fmt:formatDate value="${wl.up_date}" pattern="yyyy-MM-dd" /></td>
												<td style="width : 20%;">${wl.due_per_date }</td>
											</tr>
											</c:forEach>
											<tr>
