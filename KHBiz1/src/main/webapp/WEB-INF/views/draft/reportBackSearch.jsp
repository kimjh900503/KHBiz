								...
								<div class="content" style="text-align: center;">
									...
									<table class="table" style = "margin-bottom: 0%; text-align:  center;">
											<tr>
												...
												<td  style = "font-weight: bolder; background-color: #f2f2f2; width : 20%;">반려일</td>
											</tr>
										</table>
										...
										<table class="table table-hover" style="text-align: center;">
											...
											<c:forEach items="${reportBackSearch}" var="rbs">
												<tr id="${rbs.d_num}" class="back_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123"> 
													<td style="width : 20%; ">${rbs.sheet_kind}</td>
													<td  style="width : 20%; ">${rbs.title }</td>
													<td  style="width : 20%; "><fmt:formatDate value="${rbs.up_date}" pattern="yyyy-MM-dd" /></td>
													<td style="width : 20%; ">${rbs.approve_date}</td>
												</tr>
											</c:forEach>
											<tr>
                                    <td colspan ="5" class="divider"></td>
										...
										<div class="row">
											<div class="container-fluid">
													<form action="reportBackSearch" method="post">
														<div
