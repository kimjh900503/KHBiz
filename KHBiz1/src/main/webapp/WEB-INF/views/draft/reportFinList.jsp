								...
								<div class="content" >
									<div id="MemberListView">
										...
										<table class="table table-hover"  style="text-align: center;">
											<c:forEach items="${reportFinList}" var="rfl">
												<tr id="${rfl.d_num}" class="fin_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123">
													<input type="hidden" class="kind2" value="${rfl.kind2}">
													<td style="width : 20%;" >${rfl.sheet_kind}</td>
													<td  style="width : 20%;">${rfl.title }</td>
													<td  style="width : 20%;"><fmt:formatDate value="${rfl.up_date}" pattern="yyyy-MM-dd" /></td>
													<td  style="width : 20%;">${rfl.approve_date}</td>
												</tr>
											</c:forEach>
											<tr>
