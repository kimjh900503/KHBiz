								...
								<div class="content">
									<div id="MemberListView">
										...
										<table class="table table-hover" style="text-align:  center;">							
											...
											<tr id="${bl.d_num}" class="back_view" data-backdrop="true" data-toggle="modal" data-target="#modal-testNew123">
											<input type="hidden" value="${bl.d_num}" id="d_num">
												<td  style="width : 20%;">${bl.sheet_kind}</td>
												<td  style="width : 20%;">${bl.title}</td>
												<td  style="width : 20%;">${bl.name}</td>
												<td  style="width : 20%;"><fmt:formatDate value="${bl.up_date}" pattern="yyyy-MM-dd" /></td>
												<td  style="width : 20%;">${bl.approve_date }</td>
											</tr>
											</c:forEach>
														<tr>
									...
									<div class="container-fluid" col-md-offset-10>
													<form action="getBackSearch" method="post">
														<div
